...
$(() => {
  ...
  $.getJSON("data/propiedades.json", (respuesta) => {
    //Obtenemos los datos desde un JSON en forma estática. Es una petición asíncrona.
...
comboPropiedad.addEventListener("change", (evt) => {
  ...
  switch (
    evt.target.value //Captamos el texto de la opción elegida con evento.target.value
  ) {
    case "Split":
      renderIndex("Split");
      break;
    case "Ventana":
      ...
      break;
    case "Piso techo":
      renderIndex("Piso techo");
      break;
    case "Cassette":
      renderIndex("Cassette");
      break;
  }
});
  ...
  listaPropiedadesJSON.map((elemento) => {
    if (elemento.tipo == tipoPropiedad) {
      ...
      contenedor.innerHTML += ` 
            ...
            <li> Frigorías: ${elemento.frigorías}</li>
...
comboOperacion.addEventListener("change", (evt) => {
  ...
  switch (
    ...
    case "Instalación":
      renderIndexOperacion("Instalación");
      break;
    case "Reparación":
      renderIndexOperacion("Reparación");
      break;
  }
});
...
// EVENTO CLICK DEL combos checkbox tipo de aire --- cboxVentana

let cboxTerreno = document.querySelector("#cboxVentana");
cboxTerreno.addEventListener("click", (evt) => {
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Tipo de aire: Ventana </p>`;
  panelFiltrosActivos.style.color = "red";
  cboxTerrenoPozo.checked = false;
  cboxCasa.checked = false;
  cboxDepto.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cboxPiso Techo

let cboxTerrenoPozo = document.querySelector("#cboxPisotecho");
cboxTerrenoPozo.addEventListener("click", (evt) => {
  document.querySelector("#displayIndex").innerText = ``;
  let contenedor = document.querySelector("#displayIndex");
  listaPropiedadesJSON.map((elemento) => {
    if (elemento.tipo == "Piso techo") {
      contenedorFiltros.style.display = "";
      contenedor.innerHTML += ` 
            <div class= "contFiltradas">
            <p>
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Tipo de aire: Piso techo</p>`;
  panelFiltrosActivos.style.color = "red";
  cboxTerreno.checked = false;
  cboxCasa.checked = false;
  cboxDepto.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cboxSplit

let cboxCasa = document.querySelector("#cboxSplit");
cboxCasa.addEventListener("click", (evt) => {
  document.querySelector("#displayIndex").innerText = ``;
  let contenedor = document.querySelector("#displayIndex");
  listaPropiedadesJSON.map((elemento) => {
    if (elemento.tipo == "Split") {
      contenedorFiltros.style.display = "";
      contenedor.innerHTML += ` 
            <div class= "contFiltradas">
            <p>
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Tipo de aire: Split </p>`;
  panelFiltrosActivos.style.color = "red";
  cboxTerrenoPozo.checked = false;
  cboxTerreno.checked = false;
  cboxDepto.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cboxCassette

let cboxDepto = document.querySelector("#cboxCassette");
cboxDepto.addEventListener("click", (evt) => {
  document.querySelector("#displayIndex").innerText = ``;
  let contenedor = document.querySelector("#displayIndex");
  listaPropiedadesJSON.map((elemento) => {
    if (elemento.tipo == "Cassette") {
      contenedorFiltros.style.display = "";
      contenedor.innerHTML += ` 
            <div class= "contFiltradas">
            <p>
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Tipo de aire: Cassette </p>`;
  panelFiltrosActivos.style.color = "red";
  cboxTerrenoPozo.checked = false;
  cboxCasa.checked = false;
  cboxTerreno.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cbox1
...
cbox1.addEventListener("click", (evt) => {
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Cantidad de aires: 1 </p>`;
  panelFiltrosActivos.style.color = "red";
  cbox2.checked = false;
  cbox3.checked = false;
  cbox4.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cbox2
...
cbox2.addEventListener("click", (evt) => {
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Cantidad de aires: 2 </p>`;
  panelFiltrosActivos.style.color = "red";
  cbox1.checked = false;
  cbox3.checked = false;
  cbox4.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cbox3
...
cbox3.addEventListener("click", (evt) => {
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Cantidad de aires: 3 </p>`;
  panelFiltrosActivos.style.color = "red";
  cbox2.checked = false;
  cbox1.checked = false;
  cbox4.checked = false;
...
// EVENTO CLICK DEL combos checkbox tipo aire --- cbox4
...
cbox4.addEventListener("click", (evt) => {
  ...
  panelFiltrosActivos.innerHTML = ``;
  panelFiltrosActivos.innerHTML += `<h6 id="pfiltros">Filtros Activos:</h6>`;
  panelFiltrosActivos.innerHTML += `<p> Cantidad de aires 4 o mas</p>`;
  panelFiltrosActivos.style.color = "red";
  cbox2.checked = false;
  cbox3.checked = false;
  cbox1.checked = false;
